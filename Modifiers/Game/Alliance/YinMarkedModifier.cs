...
public sealed class YinMarkedModifier : BaseRevealModifier
{
    public override string ModifierName => "Yin Marked";
    ...
    public override bool Visible
    {
        get
        {
            ...
            return local.HasDied() ||
                   (local.TryGetModifier<YinYangModifier>(out var side) && side.Side == YinYangSide.Yin);
        }
        set { }
    }
    ...
    {
        get => $" {YinYangModifier.YinColor.ToTextColor()}{YinYangModifier.MarkSymbol}</color>";
        set { }
    }
}
